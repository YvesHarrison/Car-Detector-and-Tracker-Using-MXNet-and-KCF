...
#config.TRAIN.RPN_FG_FRACTION = 0.75
...
network.vggm = edict()
network.vggm.pretrained = 'model/bvggm_all'
network.vggm.pretrained_epoch = 20
#network.vggm.pretrained = 'model/vgg-m'
#network.vggm.pretrained_epoch = 0
#network.vggm.IMAGE_STRIDE = 0
#network.vggm.RPN_FEAT_STRIDE = 16
#network.vggm.RCNN_FEAT_STRIDE = 16
#network.vggm.base_lr = 0.001
...
dataset.hcar = edict()
dataset.hcar.dataset = 'HCar'
dataset.hcar.image_set = '5train_100_all'
dataset.hcar.test_image_set = '5test_100'
dataset.hcar.root_path = 'data'
dataset.hcar.dataset_path = 'data/hcar'
dataset.hcar.NUM_CLASSES = 6
